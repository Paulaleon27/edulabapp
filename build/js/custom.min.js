...
function init_autosize() {
	"undefined" != typeof $.fn.autosize && autosize(
		$(".resizable_textarea")
	)
}
...
function init_charts() {
	if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
		...
		if ($("#lineChart").length) {	//Gráfica #1 (Ondas)
			...
			new Chart(f, {
				...
				data: {
					...
					datasets: [{
						label: "",		//Mensaje cuando uno pone el mouse
						//backgroundColor: "rgba(76, 19, 77, 0.31)",	//Relleno de la línea de la gráfica
						borderColor: "rgba(0, 0, 0,  0.7)",		//Color de la línea de la gráfica
						pointBorderColor: "rgba(0, 0, 0,  0.7)",		//Borde de los puntos de la gráfica
						pointBackgroundColor: "rgba(0, 0, 0, 0.7)",		//Relleno de los puntos de la gráfica
						pointHoverBackgroundColor: "#000000",				//Relleno de los puntos de la gráfica(E)
						pointHoverBorderColor: "rgba(0, 0, 0,  0.7)",	//Borde de los puntos de la gráfica(E)
						pointBorderWidth: 1,		//Cambiar tamaño del punto
						data: [31, 74, 6, 39, 20, 85, 7]		//Datos de la gráfica
					}, {
						label: "",		//Mensaje cuando uno pone el mouse
						//backgroundColor: "rgba(0, 159, 51, 0.3)",			//Relleno de la línea de la gráfica
						borderColor: "rgba(0, 159, 51, 0.70)",				//Color de la línea de la gráfica
						pointBorderColor: "rgba(0, 159, 51, 0.70)",			//Borde de los puntos de la gráfica
						pointBackgroundColor: "rgba(0, 159, 51, 0.70)",		//Relleno de los puntos de la gráfica
						pointHoverBackgroundColor: "#009f33",				//Relleno de los puntos de la gráfica(E)
						pointHoverBorderColor: "rgba(0, 159, 51, 1)",				//Borde de los puntos de la gráfica(E)
						pointBorderWidth: 1,
						data: [82, 23, 66, 9, 99, 4, 2]		//Datos de la gráfica
					}]
				}
			})
		}
		if ($("#mybarChart").length) {		//Gráfica #2 (Barras)
			...
			new Chart(f, {
				...
				data: {
					...
					datasets: [{
						label: "",		//Mensaje cuando uno pone el mouse
						backgroundColor: "#000000",		//Relleno de la barra
						data: [51, 30, 40, 28, 92, 50, 45]		//Datos de la gráfica
					}, {
						label: "",		//Mensaje cuando uno pone el mouse
						backgroundColor: "#009f33",		//Relleno de la barra
						data: [41, 56, 25, 48, 72, 34, 12]		//Datos de la gráfica
					}]
				},
				options: {
					scales: {
		...
		if ($("#canvasRadar").length) {		// Gráfica #3
			var f = document.getElementById("canvasRadar"),
				i = {
					labels: ["Algo", "Algo#1", "Algo#2", "Algo#3", "Algo#4", "Algo#5", "Algo#6"],
					datasets: [{
						label: "Mi primer resultado",
						backgroundColor: "rgba(0, 0, 0, 0.2)",	// Relleno de la línea de la gráfica
						borderColor: "rgba(0, 0, 0, 0.80)",		//Color de la línea de la gráfica
						pointBorderColor: "rgba(0, 0, 0, 0.80)",		//Borde del punto de la línea de la gráfica 
						pointBackgroundColor: "rgba(0, 0, 0, 1)",		//Relleno del punto de la línea de la gráfica
						pointHoverBackgroundColor: "#000000",		//Relleno del punto principal(E)
						pointHoverBorderColor: "#000000",		//Borde del punto principal(E)
						data: [50, 60, 75, 27, 100, 80, 100]		//Datos de la gráfica
					}, {
						label: "Mi segundo resultado",
						backgroundColor: "rgba(0, 159, 51, 0.2)",	// Relleno de la línea de la gráfica
						borderColor: "rgba(0, 159, 51, 0.80)",		//Color de la línea de la gráfica
						pointBorderColor: "rgba(0, 159, 51, 0.80)",		//Borde del punto de la línea de la gráfica 
						pointBackgroundColor: "rgba(0, 159, 51, 1)",		//Relleno del punto de la línea de la gráfica
						pointHoverBackgroundColor: "#009f33",		//Relleno del punto principal(E)
						pointHoverBorderColor: "#009f33",		//Borde del punto principal(E)
						pointStrokeColor: "#009f33",
						pointHighlightFill: "#ff0000",
						pointHighlightStroke: "rgba(151,187,205,1)",
						data: [50, 100, 27, 75, 50, 60, 70]		//Datos de la gráfica
					}]
				};
			new Chart(f, {
				type: "radar",
	...
	if ("undefined" != typeof $.fn.fullCalendar) {
		...
		var e, f, a = new Date,
			...
			g = $("#calendar").fullCalendar({
				...
				editable: !0,
				events: [{				//Eventos que venían en la plantilla
					title: "Clase 10:00 a.m.",
					start: new Date(d, c, 1)		//Día en el calendario 
				}, {
					title: "Clase 2:00 p.m.",
					start: new Date(d, c, b - 5),
					end: new Date(d, c, b - 2)
				}, {
					title: "Clase 3:00 p.m.",
					start: new Date(d, c, b, 10, 30),
					allDay: !1
				}, {
					title: "Clase 4:00 p.m.",
					start: new Date(d, c, b + 10, 16, 0),		//Los dos últimos números es la hora
					end: new Date(d, c, b, 14, 0),
					allDay: !1
				}, {
					title: "Clase 5:00 p.m.",
...
function init_morris_charts() {
	"undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
		...
		labels: ["Geekbench"],
		barRatio: .4,
		barColors: ["#000000", "#34495E", "#ACADAC", "#3498DB"],		//PRIMER: Color de las barras (PERFIL)
		xLabelAngle: 35,
		hideHover: "auto",
		resize: !0
...
function init_echarts() {
	if ("undefined" != typeof echarts) {
		...
		var a = {
			color: ["#009f33", "#000000", "#BDC3C7", "#3498DB", "#9B59B6", "#8abb6f", "#759c6a", "#bfd3b7"],	//Los dos primeros cambia el color a la gráfica(Proyectos)
			title: {
				itemGap: 8,
				textStyle: {
					fontWeight: "normal",
					color: "#73879c"		//Color del título
				}
			},
			dataRange: {
				color: ["#1f610a", "#97b58d"]
			...
			tooltip: {
				...
				axisPointer: {
					type: "line",
					lineStyle: {
						color: "rgba(0,0,0,0.5)",		//Color de la línea de atrás de la gráfica
						type: "dashed"
					},
					crossStyle: {
						color: "#408829"
			...
			categoryAxis: {
				axisLine: {
					lineStyle: {
						color: "#000000"		//Color línea de abajo de la gráfica
					}
				},
				splitLine: {
					lineStyle: {
			...
			valueAxis: {
				axisLine: {
					lineStyle: {
						color: "#000000"		//Color línea izquierda de la gráfica
					}
				},
				splitArea: {
					show: !0,
		...
		if ($("#mainb").length) {		//Gráfica del proyecto
			var b = echarts.init(document.getElementById("mainb"), a);
			b.setOption({
				title: {
					text: "Nombre del proyecto",		//Título de la gráfica
					subtext: "Aquí va algo"				//Subtítulo de la gráfica
				},
				tooltip: {
					trigger: "axis"
				},
				legend: {
					data: ["proyecto1", "proyecto"]		//También cambiar en las líneas 2294 y 2313
				},
				toolbox: {
					show: !1
				},
				...
				xAxis: [{
					type: "category",
					data: ["En", "Fb", "Mr", "Ab", "My", "Jn", "Jl", "Ag", "Sp", "Oc", "Nv", "Dc"]
				}],
				yAxis: [{
					type: "value"
				}],
				series: [{
					name: "proyecto1",		//Leyenda 1
					type: "bar",
					data: [27, 50, 80, 100, 100, 67, 80, 127.4, 32.6, 27, 36.4, 33.3],		//Datos de la gráfica
					markPoint: {
						data: [{
							type: "max",		//Muestra el dato más grande entre las barras
							name: "max"
						}, {
							type: "min",		//Muestra el dato más pequeño entre las barras
							name: "min"
						}]
					},
					markLine: {
					...
					name: "proyecto",		//Leyenda 
					type: "bar",
					data: [30, 50, 90, 36.4, 28.7, 70.7, 127.4, 82.2, 48.7, 27, 60, 30],		//Datos de la gráfica
					markPoint: {
						data: [{
							type: "max",		//Muestra el dato más grande entre las barras
							name: "max"
